...
const MENU_ITEMS = {
  es: {
    ...
    hendricks: { name: "Hendrick's" },
    ginMare: { name: "Gin Mare" },
    seagrams: { name: "Seagrams" },
    tanqueray: { name: "Tanqueray" },
    bulldog: { name: "Bulldog" },
    ginMg: { name: "Gin MG" },
    greyGoose: { name: "Grey Goose" },
    absolut: { name: "Absolut" },
    skyy: { name: "Skyy" },
    zacapa: { name: "Zacapa" },
    brugal: { name: "Brugal" },
    abueloAnejo: { name: "Abuelo Añejo" },
    glenmorangie: { name: "Glenmorangie" },
    johnnieWalker: { name: "Johnnie Walker Black Label" },
    jackDaniels: { name: "Jack Daniel's" },
    herradura: { name: "Herradura Reposado" },
    joseCuervo: { name: "Jose Cuervo Tradicional" },
    mezcalUnion: { name: "Mezcal Unión" },
    fernet: { name: "Fernet" },
    ratafia: { name: "Ratafia «L'Hostia»" },
    limoncello: { name: "Limoncello «Villa Massa»" },
    baileys: { name: "Baileys" },
    campariShot: { name: "Campari" },
    disaronno: { name: "Disaronno" },
    aperolShot: { name: "Aperol" },
